...
function bundle.hooks.on_source(bundle)
  ...
  call smartinput#define_rule({'at': 'Unite[^:]*file\%#', 'char': 'R', 'input': '_rec', 'mode': ':'})
  call smartinput#define_rule({'at': 'Unite[^:]*file\%#', 'char': 'M', 'input': '_mru ', 'mode': ':'})
  call smartinput#define_rule({'at': 'Unite[^:]*file_rec\%#', 'char': 'A', 'input': '/async ', 'mode': ':'})
